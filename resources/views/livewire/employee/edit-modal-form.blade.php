<x-delay>
    <div>
        <form submit="" wire:submit.prevent="update" method="POST" class="overflow-auto h-5/6">
            @csrf
            <x-jet-confirmation-modal wire:model="isModalOpen">
                ...
                <x-slot name="footer">
                    <div class="col-span-12 flex items-center justify-end px-4 py-3 bg-gray-50 text-right sm:px-6 mt-4 rounded ">
                        <x-jet-secondary-button wire:click="closeModal" wire:loading.attr="disabled" class="pr-3">
                            {{ __('Cancel') }}
