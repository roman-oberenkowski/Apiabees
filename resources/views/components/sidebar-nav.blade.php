<aside class="bg-gradient-to-b from-dark_blue to-teal-900 text-gray-100 md:min-h-screen shadow overflow-hidden shadow-2xl">
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-2">
        ...
        <div class="font-semibold text-xl text-gray-100 leading-tight py-4">
            ...
            <x-sidebar-nav-link href="{{ route('attendances.index') }}" :active="request()->is('attendance')"> <i class="fab fa-accusoft pr-1"></i>  {{ __('Attendance') }} </x-sidebar-nav-link>
            ...
            <x-sidebar-nav-link href="{{ route('scanner.scan') }}" :active="request()->is('scanner.scan')"> <i class="fab fa-accusoft pr-1"></i>  {{ __('Scanner') }} </x-sidebar-nav-link>
        </div>
    </div>
</aside>
